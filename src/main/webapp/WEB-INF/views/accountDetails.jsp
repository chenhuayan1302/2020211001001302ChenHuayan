		...
		<div class="container">
			...
			<div class="col-sm-6">
				<div class="total_area">
					...
					%>
						<ul>
							<li>Username :<span><%=user.getUsername()%></span></li>
							<li>Password :<span><%=user.getPassword()%></span></li>
							<li>Email :<span><%=user.getEmail()%></span></li>
							<li>Gender :<span><%=user.getGender()%></span></li>
							<li>Birthdays:<span><%=user.getBirthdays()%></span></li>
						</ul>
   						<a class="btn btn-default update" href="updateUser?id=<%=user.getId()%>">Update</a>
					<%}%>
			...
			<h1>No Order Found.</h1>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td class="cart_total">
						<%
							com.Chenhuayan.model.Order o=(com.Chenhuayan.model.Order)pageContext.findAttribute("o");
							int n=o.getPaymentId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							String paymentType=com.Chenhuayan.model.Payment.findByPaymentId(con,n);
							 %>
