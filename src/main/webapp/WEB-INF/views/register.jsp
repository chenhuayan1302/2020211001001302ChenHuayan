...
style="width: 15px; height: 15px; display:inline;" name="sex" value="male" checked/>&nbsp;Male&nbsp;<input type="radio" style="width: 15px; height: 15px;   display: inline;" name="sex" value="female"/>&nbsp;Female</span>
   <span></span>
   <input type="text" name="Birthdays" placeholder="Date of Birth (yyyy-mm-dd)">
